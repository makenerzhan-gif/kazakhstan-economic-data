...
import update_bns, update_nbk, update_minfin, update_imf, update_ardfm, update_wb, update_kase  # noqa: E402
...
def main() -> int:
    ...
    for module in (update_bns, update_nbk, update_minfin, update_imf, update_ardfm, update_wb, update_kase, update_dims, update_derived):
        module.run(logger)
