...
FETCHERS = {
    ...
    "LABOR_FORCE": bns_fetchers.fetch_labor_force,
    "LABOR_FORCE_PARTICIPATION_RATE": bns_fetchers.fetch_labor_force_participation_rate,
    "EMPLOYED_QUARTERLY": bns_fetchers.fetch_employed_quarterly,
    "UNEMPLOYED_PERSONS": bns_fetchers.fetch_unemployed_persons,
    "YOUTH_UNEMPLOYMENT_RATE": bns_fetchers.fetch_youth_unemployment_rate,
    "LONG_TERM_UNEMPLOYMENT_RATE": bns_fetchers.fetch_long_term_unemployment_rate,
    "AVG_WAGE_QUARTERLY": bns_fetchers.fetch_avg_wage_quarterly,
    "REAL_WAGE_INDEX_QUARTERLY": bns_fetchers.fetch_real_wage_index_quarterly,
    "FREIGHT_TURNOVER_MONTHLY": bns_fetchers.fetch_freight_turnover_monthly,
    "PASSENGER_TURNOVER_MONTHLY": bns_fetchers.fetch_passenger_turnover_monthly,
    "FREIGHT_CARRIED": bns_fetchers.fetch_freight_carried,
    "PASSENGERS_CARRIED": bns_fetchers.fetch_passengers_carried,
    "GINI_COEFFICIENT": bns_fetchers.fetch_gini_coefficient,
    "DECILE_INCOME_RATIO": bns_fetchers.fetch_decile_income_ratio,
    "POVERTY_DEPTH": bns_fetchers.fetch_poverty_depth,
    "POVERTY_SEVERITY": bns_fetchers.fetch_poverty_severity,
    "CORE_CPI_YOY_EX3": bns_fetchers.fetch_core_cpi_yoy_ex3,
    "CORE_CPI_MOM_EX3": bns_fetchers.fetch_core_cpi_mom_ex3,
    "CORE_CPI_YOY_EX7": bns_fetchers.fetch_core_cpi_yoy_ex7,
    "CORE_CPI_MOM_EX7": bns_fetchers.fetch_core_cpi_mom_ex7,
    "AVG_WAGE_MINING": bns_fetchers.fetch_avg_wage_mining,
    "REAL_WAGE_INDEX_MINING": bns_fetchers.fetch_real_wage_index_mining,
    "AVG_WAGE_MANUFACTURING": bns_fetchers.fetch_avg_wage_manufacturing,
    "REAL_WAGE_INDEX_MANUFACTURING": bns_fetchers.fetch_real_wage_index_manufacturing,
    "AVG_WAGE_AGRICULTURE": bns_fetchers.fetch_avg_wage_agriculture,
    "REAL_WAGE_INDEX_AGRICULTURE": bns_fetchers.fetch_real_wage_index_agriculture,
    "AVG_WAGE_CONSTRUCTION": bns_fetchers.fetch_avg_wage_construction,
    "REAL_WAGE_INDEX_CONSTRUCTION": bns_fetchers.fetch_real_wage_index_construction,
    "AVG_WAGE_FINANCE": bns_fetchers.fetch_avg_wage_finance,
    "REAL_WAGE_INDEX_FINANCE": bns_fetchers.fetch_real_wage_index_finance,
    "AVG_WAGE_EDUCATION": bns_fetchers.fetch_avg_wage_education,
    "REAL_WAGE_INDEX_EDUCATION": bns_fetchers.fetch_real_wage_index_education,
...
INDICATOR_IDS = [
    ...
    "CONSTRUCTION", "REAL_WAGE_INDEX", "BIRTHS_TOTAL", "DEATHS_TOTAL", "HOUSING_COMMISSIONED", "PPI",
    ...
    "ENERGY_INTENSITY", "ENERGY_CONSUMPTION", "FINAL_ENERGY_CONSUMPTION", "RENEWABLE_ENERGY_SHARE", "POVERTY_HEADCOUNT",
