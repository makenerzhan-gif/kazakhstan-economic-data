...
- **bns/CORE_CPI_YOY_EX3** — fetch+validate+process: ok (downloaded=43, processed=43)
  - warning: Gap of 61 days between 2026-03-01 and 2026-05-01 is outside expected range for frequency=monthly (25-40d).
- **bns/CORE_CPI_MOM_EX3** — fetch+validate+process: ok (downloaded=43, processed=43)
  - warning: Gap of 61 days between 2026-03-01 and 2026-05-01 is outside expected range for frequency=monthly (25-40d).
- **bns/CORE_CPI_YOY_EX7** — fetch+validate+process: ok (downloaded=43, processed=43)
  - warning: Gap of 61 days between 2026-03-01 and 2026-05-01 is outside expected range for frequency=monthly (25-40d).
- **bns/CORE_CPI_MOM_EX7** — fetch+validate+process: ok (downloaded=43, processed=43)
  - warning: Gap of 61 days between 2026-03-01 and 2026-05-01 is outside expected range for frequency=monthly (25-40d).
...
- **nbk/EXCHANGE_RATE** — fetch+validate+process: ok (downloaded=1379, processed=1379)
...
- **nbk/TONIA** — fetch+validate+process: ok (downloaded=200, processed=200)
...
- **bns/EXPORTS** — derive+validate+process: ok (downloaded=0, processed=138)
...
- **bns/OIL_EXPORTS_VOLUME** — derive+validate+process: ok (downloaded=0, processed=137)
...
- **bns/OIL_EXPORTS_VALUE** — derive+validate+process: ok (downloaded=0, processed=137)
  - warning: Gap of 61 days between 2022-08-01 and 2022-10-01 is outside expected range for frequency=monthly (25-40d).
